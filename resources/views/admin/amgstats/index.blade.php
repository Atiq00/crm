                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-9">
                                <h3 class="mb-0">Manage AMG Stats</h3>
                            </div>
                            <div class="col-3">
                                <a href="{{route('amg.create')}}" class="btn btn-info float-right m-1">AMG-Form </a>
                                @if (isset($_GET['search']))
                                    <a href="{{ route('amg.sales-report') }}?start_date={{ $start_date }}&end_date={{ $end_date }}"
                                        class="btn btn-info float-right">Export</a>
                                @else
                                    <a href="{{ route('amg.sales-report') }}"
                    ...
                    <div>
                        <form action="{{ route('amg.index') }}" method="GET" class="search p-3">
                            @csrf
                            <div class="row">
                    ...
                    <div class="table-responsive pb-3">
                        @include('admin.amgstats.sales-report')
                    </div>
                </div>
            </div>
