@extends('admin.layouts.app', ['current_page' => 'TBBCALL-submission'])

@section('content')

    @push('header-buttons')
        <div class="col-lg-6 col-5 text-right">
            <a href="{{ route('tbbcall.create') }}" class="btn btn-sm btn-icon btn-neutral">
                <i data-feather="arrow-left" stroke-width="3" width="12"></i> Go Back</a>
        </div>
    @endpush
    @include('admin.layouts.headers.cards', ['title' => 'TBBCALL-submission'])
            ...
            <div class="col">
                <div class="card shadow">
                    <div class="card-header border-0">
                        ...
                        @endif
                        <form action="{{ route('tbbcall.store') }}" method="POST" id="webform">
                            @csrf
                            <div class="row">
                                ...
                                <div class="form-group col-md-6" style="display: block" id="no_of_call_count">
                                    <span class="details">No of calls</span>
                                    <input style="color: black" required type="text" name="no_of_call_count"
                                        data-id="no_of_call_count" class="form-control" placeholder="No of Call">
                                </div>
                                <div class="form-group col-md-6" style="display: block" id="quotation_count">
                                    <span class="details">Quotations from calls</span>
                                    <input style="color: black" required type="text" name="quotation_count"
                                        data-id="quotation_count" class="form-control" placeholder="Quotation from call">
                                </div>
                                <div class="form-group col-md-6" style="display: block" id="bookings_count">
                                    <span class="details">Bookings</span>
                                    <input style="color: black" required type="text" name="bookings_count"
                                        data-id="bookings_count" class="form-control" placeholder="Bookings">
                                </div>
                                <div class="form-group col-md-6" style="display: block" id="avg_time_request">
                                    <span class="details">Average Handling time</span>
                                    <input style="color: black" required type="text" name="avg_time_request"
                                        data-id="avg_time_request" class="form-control" placeholder="Avg handling time">
                                </div>
                                <div class="form-group col-md-6" style="display: block" id="quotation_id">
                                    ...
                                    <input style="color: black" required type="text" name="quotation_id"
                                        data-id="quotation_id" class="form-control" placeholder="Quotation">
                                </div>
