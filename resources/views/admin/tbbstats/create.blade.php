...
@section('content')
    ...
    @push('header-buttons')
        <div class="col-lg-6 col-5 text-right">
            <a href="{{ route('tbb.create') }}" class="btn btn-sm btn-icon btn-neutral">
            ...
            <div class="col">
                <div class="card shadow">
                    <div class="card-header border-0">
                        ...
                        @endif
                        <form action="{{ route('tbb.store') }}" method="POST" id="webform">
                            @csrf
                            <div class="row">
                                ...
                                <div class="form-group col-md-6" style="display: block" id="package_request_count">
                                    <span class="details">Packages</span>
                                    <input style="color: black" required type="text" name="package_request_count"
                                        data-id="package_request_count" class="form-control" placeholder="Packages Request">
                                </div>
                                <div class="form-group col-md-6" style="display: block" id="cruise_request_count">
                                    <span class="details">Cruise</span>
                                    <input style="color: black" required type="text" name="cruise_request_count"
                                        data-id="cruise_request_count" class="form-control" placeholder="Cruise Request">
                                </div>
                                <div class="form-group col-md-6" style="display: block" id="chat_request_count">
                                    <span class="details">Onlinechat</span>
                                    <input style="color: black" required type="text" name="chat_request_count"
                                        data-id="chat_request_count" class="form-control" placeholder="Online chat Request">
                                </div>
                                <div class="form-group col-md-6" style="display: block" id="quotation_id">
                                    ...
                                    <input style="color: black" required type="text" name="quotation_id"
                                        data-id="quotation_id" class="form-control" placeholder="Online chat Request">
                                </div>
                                ...
                                <input type="hidden" name="project_code" value="PRO0209">
                                <input type="hidden" name="client_code" value="CUS-100059">
