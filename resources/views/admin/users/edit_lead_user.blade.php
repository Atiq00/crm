...
<style> 
    ...
    @push('header-buttons')
        <div class="col-lg-6 col-5 text-right">
          <a href="{{ route('lead_users') }}" class="btn btn-sm btn-icon btn-neutral">
        ...
        <div class="row">
            <div class="col">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('edit_lead_user') }}" id="my-form" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            @method('post')
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 text-right">
                                    <button type="submit" name="submit" value="lead_submit" class="btn btn-info  btn-block mt-4">{{ __('labels.submit') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>                    
