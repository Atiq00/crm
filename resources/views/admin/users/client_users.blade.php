@extends('admin.layouts.app', [ 'current_page' => 'client user' ])
...
<style>
    ...
    @include('admin.layouts.headers.cards', ['title' => "Client Users"])
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    @can('users.edit')
                                                        <a class="dropdown-item" href="{{ route('edit_client_user', $user->id) }}">{{ __('labels.edit') }}</a>
                                                    @endcan
                                                    @can('users.delete')
