@extends('admin.layouts.app', ['current_page' => 'home-warranty-external-submission'])

@section('content')

@push('header-buttons')
        <div class="col-lg-6 col-5 text-right">
          <a href="{{ route('homewarrantyexternal.create') }}" class="btn btn-sm btn-icon btn-neutral">
            <i data-feather="arrow-left" stroke-width="3" width="12"></i> Go Back</a>
        </div>
    @endpush
    @include('admin.layouts.headers.cards', ['title' => 'home-warranty-external-submission'])
            ...
            <div class="col">
                <div class="card shadow">
                    <div class="card-header border-0">
                        ...
                        @endif
                        <form action="{{ route('homewarrantyexternal.store') }}" method="POST" id="webform">
                            @csrf
