@extends('admin.layouts.app', ['current_page' => 'homewarrantyDGS'])
...
@section('content')
    ...
    @endphp
    @include('admin.layouts.headers.cards', ['title' => 'homewarrantyDGS'])
                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-9">
                                <h3 class="mb-0">Manage HomeWarranty External Campaign</h3>
                            </div>
                            
                        </div>
                    </div>
                    <div>
                        <form action="{{ route('homewarrantyDGS.index') }}" method="GET" class="search p-3">
                            @csrf
                            <div class="row">
                                ...
                                <div class="form-group col-md-1" style="margin-top: 20px;">
                                    ...
                                    <a href="{{ route('homewarrantyDGS.create') }}" class="btn btn-info float-right m-1">Submission</a>
                                </div>
                                @endif
                                {{-- <div class="form-group col-md-1" style="margin-top: 20px;">
                                    @if (isset($_GET['search']))
                    ...
                    <div class="table-responsive pb-3">
                        @include('admin.homewarrantyexternal.dgs.sales-report')
                        <div class="col-md-12 p-2">
                            {{ $home_warranty_external->links() }}
                        </div>
                    </div>
