@extends('admin.layouts.app', ['current_page' => 'homewarrantyAMS'])
...
@section('content')
    ...
    @endphp
    @include('admin.layouts.headers.cards', ['title' => 'homewarrantyAMS'])
        ...
        <div class="row">
            <div class="col">
                <div class="card shadow">
                    ...
                    <div>
                        <form action="{{ route('homewarrantyAMS.index') }}" method="GET" class="search p-3">
                            @csrf
                            <div class="row">
                                ...
                                <div class="form-group col-md-1" style="margin-top: 20px;">
                                    ...
                                    <a href="{{ route('homewarrantyAMS.create') }}" class="btn btn-info float-right m-1">Submission</a>
                                </div>
                                @endif
                                {{-- <div class="form-group col-md-1" style="margin-top: 20px;">
                                    @if (isset($_GET['search']))
                    ...
                    <div class="table-responsive pb-3">
                        @include('admin.homewarrantyexternal.ams.sales-report')
