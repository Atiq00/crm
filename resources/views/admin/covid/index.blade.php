@extends('admin.layouts.app', ['current_page' => 'covid'])
...
@section('content')
    ...
    @endphp
    @include('admin.layouts.headers.cards', ['title' => 'Covid'])
                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-9">
                                <h3 class="mb-0">Manage Covid Kit</h3>
                            </div>
                            @if(auth()->user()->hasRole('Super Admin'))
                            {{-- <div class="col-3">
                                <a href="{{ route('covid.create') }}" class="btn btn-info float-right m-1">Sale
                                    Submission</a>
                                @if (isset($_GET['search']))
                                    <a href="{{ route('covid.sales-report') }}?start_date={{ $start_date }}&end_date={{ $end_date }}&phone={{ $phone }}"
                    ...
                    <div>
                        <form action="{{ route('covid.index') }}" method="GET" class="search p-3">
                            @csrf
                            <div class="row">
                                ...
                                <div class="form-group col-md-1" style="margin-top: 20px;">
                                    ...
                                    <a href="{{ route('covid.create') }}" class="btn btn-info float-right m-1">Submission</a>
                                </div>
                                @endif
                                {{-- <div class="form-group col-md-1" style="margin-top: 20px;">
                                    @if (isset($_GET['search']))
                                    ...
                                    @else
                                        <a href="{{ route('covid.sales-report') }}"
                                            class="btn btn-info float-right form-control m-1">Export</a>
                                    @endif
                                </div> --}}
                                <div>
                    ...
                    <div class="table-responsive pb-3">
                        @include('admin.covid.sales-report')
