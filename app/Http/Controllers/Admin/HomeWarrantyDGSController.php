...
class HomeWarrantyDGSController extends Controller
{
    public function __construct()
    {
        view()->share('site', (object) [
            'title' =>  "homewarrantyDGS"
        ]);
    }
    /**
    ...
    {
        $this->authorize('homewarrantyDGS.index'); 
        ...
        $home_warranty_external = $query->with('project','client')->where('type','DGS-BPO')->latest()->paginate(1000);

        return view('admin.homewarrantyexternal.dgs.index',compact('home_warranty_external'));
    }
    ...
    {
        $this->authorize('homewarrantyDGS.create'); 
        return view('admin.homewarrantyexternal.dgs.create');
    }
    ...
    { 
        $this->authorize('homewarrantyDGS.store'); 
        ...
        $request->merge([
            'type' => "DGS-BPO",
            'client_code' => "CUS-100080",
            'project_code' => "PRO0188",
        ]);
    ...
    {
        $this->authorize('homewarrantyDGS.show'); 
        return view('admin.homewarrantyexternal.dgs.show',compact('home_warranty_external'));
    }
    ...
    {
        // return view('admin.homewarrantyexternal.dgs.edit',compact('home_warranty_external'));
    }
    ...
    {
        $this->authorize('homewarrantyDGS.update'); 
    ...
    {
        $this->authorize('homewarrantyDGS.delete'); 
