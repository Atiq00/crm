...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('sale_records', function (Blueprint $table) {
            ...
            $table->string('record_id', 30)->default('0')->unique('record_id');
            ...
            $table->string('vendor_lead_id', 255);
            ...
            $table->enum('client_status', ['billable', 'not-billable', 'unsuccessfull-transfer', 'pending'])->default('pending');
            ...
            $table->enum('sol', ['0', '1'])->default('0');
            $table->string('reporting_to_name', 150)->nullable();
            $table->integer('reporting_to')->nullable()->default(0);
            $table->string('designation', 190)->nullable()->default('0');
            $table->string('campaign_name', 150)->nullable();
        });
    }
