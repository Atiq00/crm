...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('amg_sales_stats', function (Blueprint $table) {
            ...
            $table->integer('live_request_count')->nullable();
            $table->integer('test_request_count')->nullable();
            $table->string('avg_time_request', 150)->nullable();
            $table->integer('total_livetest_count')->nullable();
    ...
    {
        Schema::dropIfExists('amg_sales_stats');
    }
};
