...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('backup_sale_records_before_update_trigger', function (Blueprint $table) {
            $table->unsignedBigInteger('id')->nullable();
            $table->string('campaign_id', 15)->nullable();
            $table->string('latitude', 120)->nullable();
            $table->string('longitude', 120)->nullable();
            $table->string('record_id', 30)->nullable()->default('0');
    ...
    {
        Schema::dropIfExists('backup_sale_records_before_update_trigger');
    }
};
